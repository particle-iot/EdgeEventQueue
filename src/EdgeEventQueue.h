#ifndef __EDGEEVENTQUEUE_H
#define __EDGEEVENTQUEUE_H
...
public: 
     ...
     * 
     * Typically used as: EdgeEventQueue::instance().setup();
     * 
     ...
     * 
     * Typically used as: EdgeEventQueue::instance().loop();
     */
    void loop();
     ...
     * 
     * @return EdgeEventQueue& Reference to this object to chain, fluent-style
     */
    EdgeEventQueue &withPriority(size_t priority) { this->priority = priority; return *this; };

    /**
     * @brief Sets the publish flags such as NO_ACK.
     * 
     * @param flags 
     * @return EdgeEventQueue& 
     */
    EdgeEventQueue &withPublishFlags(PublishFlags flags) { this->publishFlags = publishFlags; return *this; };
     ...
     * @return EdgeEventQueue& Reference to this object to chain, fluent-style
     */
    EdgeEventQueue &withSizeLimit(size_t sizeLimit) { this->sizeLimit = sizeLimit; return *this; };
     ...
     * @return EdgeEventQueue& Reference to this object to chain, fluent-style
     */
    EdgeEventQueue &withDiskQueuePolicy(DiskQueuePolicy policy) { this->policy = policy; return *this; };
     ...
     * @return EdgeEventQueue& Reference to this object to chain, fluent-style
     */
    EdgeEventQueue &withQueuePath(const char *path) { this->path = path; return *this; };
...
private:
     ...
     */
    EdgeEventQueue(const EdgeEventQueue&) = delete;

    /**
     * @brief This class is not copyable
     */
    EdgeEventQueue& operator=(const EdgeEventQueue&) = delete;
