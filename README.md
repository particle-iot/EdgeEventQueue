...
- [Browseable API docs](https://particle-iot.github.io/EdgeEventQueue/index.html)
...
functions of your Edge software, there are no library examples in this repository as they wouldn't be able to be compiled successfully.
...
To do this, use `EdgeEventQueue::cloudServicePublish`, which takes an eventName and eventData. 
